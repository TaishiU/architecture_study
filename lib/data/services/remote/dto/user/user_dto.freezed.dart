...
/// ID
 ...
 String? get lastName;/// 旧姓
 String? get maidenName;/// 年齢
 int? get age;/// 性別
 String? get gender;/// メールアドレス
 String? get email;/// 電話番号
 String? get phone;/// ユーザー名
 String? get username;/// パスワード
 String? get password;/// 生年月日
 String? get birthDate;/// 画像
 String? get image;/// 血液型
 String? get bloodGroup;/// 身長
 double? get height;/// 体重
 double? get weight;/// 目の色
 String? get eyeColor;/// 髪
 Hair? get hair;/// IPアドレス
 String? get ip;/// 住所
 Address? get address;/// MACアドレス
 String? get macAddress;/// 大学
 String? get university;/// 銀行
 Bank? get bank;/// 会社
 Company? get company;/// EIN
 String? get ein;/// SSN
 String? get ssn;/// ユーザーエージェント
 String? get userAgent;/// 暗号資産
 Crypto? get crypto;/// 役割
 String? get role;
...
as Hair?,ip: freezed == ip ? _self.ip : ip // ignore: cast_nullable_to_non_nullable
as String?,address: freezed == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as Address?,macAddress: freezed == macAddress ? _self.macAddress : macAddress // ignore: cast_nullable_to_non_nullable
...
as Bank?,company: freezed == company ? _self.company : company // ignore: cast_nullable_to_non_nullable
as Company?,ein: freezed == ein ? _self.ein : ein // ignore: cast_nullable_to_non_nullable
...
as Crypto?,role: freezed == role ? _self.role : role // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of UserDto
...
class _Hair implements Hair {
  const _Hair({this.color, this.type});
...
/// 住所
 String? get address;/// 市区町村
 String? get city;/// 州
 String? get state;/// 州コード
 String? get stateCode;/// 郵便番号
 String? get postalCode;/// 座標
 Coordinates? get coordinates;/// 国
 String? get country;
...
as Coordinates?,country: freezed == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of Address
...
class _Address implements Address {
  const _Address({this.address, this.city, this.state, this.stateCode, this.postalCode, this.coordinates, this.country});
...
/// カード有効期限
 String? get cardExpire;/// カード番号
 String? get cardNumber;/// カードタイプ
 String? get cardType;/// 通貨
 String? get currency;/// IBAN
 String? get iban;
...
class _Bank implements Bank {
  const _Bank({this.cardExpire, this.cardNumber, this.cardType, this.currency, this.iban});
...
class _Company implements Company {
  const _Company({this.department, this.name, this.title, this.address});
...
/// コイン
 String? get coin;/// ウォレット
 String? get wallet;/// ネットワーク
 String? get network;
...
class _Crypto implements Crypto {
  const _Crypto({this.coin, this.wallet, this.network});
